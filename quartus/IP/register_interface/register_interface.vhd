...
entity register_interface is
	...
	(
		...
		debug_n    : in  std_logic;  								--! Debug enable
...
--!			- all five registers
--!         - 8 green LEDs showing speedReg with 0 .. 2
--!         - 8 red LEDs showing ctrlReg
--!			- generating motor interrupt
architecture my_register_interface of register_interface is
   --! @brief Component Declaration for 32-bit register 
	component register_32bit is
		port
		(
			clock	   : in  std_logic;  							--! clock
			reset_n	: in  std_logic;  							--! low active reset: clears data
...
begin
	 ...
	 --!        - output speedReg to green Leds
	 --!        - output ctrlReg to red Leds
	 --!        - writing registers
	 --!			- reading registers
