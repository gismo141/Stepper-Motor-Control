...
ensure_lib                                      ./libraries/motor_control_unit_0                
vmap       motor_control_unit_0                 ./libraries/motor_control_unit_0                
ensure_lib                                      ./libraries/registers                           
vmap       registers                            ./libraries/registers                           
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_width_adapter.sv"                                             -work SRAM_CVGX_uas_rsp_width_adapter     
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_address_alignment.sv"                                         -work SRAM_CVGX_uas_rsp_width_adapter     
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                        -work SRAM_CVGX_uas_rsp_width_adapter     
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_adapter_13_1.sv"                                        -work SRAM_CVGX_uas_burst_adapter         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_adapter_new.sv"                                         -work SRAM_CVGX_uas_burst_adapter         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_adapter.sv"                                             -work SRAM_CVGX_uas_burst_adapter         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_incr_burst_converter.sv"                                             -work SRAM_CVGX_uas_burst_adapter         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_wrap_burst_converter.sv"                                             -work SRAM_CVGX_uas_burst_adapter         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_default_burst_converter.sv"                                          -work SRAM_CVGX_uas_burst_adapter         
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                               -work CPU_jtag_debug_module_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                        -work CPU_jtag_debug_module_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_agent.sv"                                              -work CPU_instruction_master_agent        
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                          -work slave_translator                    
  ...
  vcom  "$QSYS_SIMDIR/submodules/steppermotorcontrol_mm_interconnect_0_registers_register_slave_translator.vhd"    -work mm_interconnect_0                   
  ...
  vcom  "$QSYS_SIMDIR/submodules/motor_control_unit.vhd"                                                           -work motor_control_unit_0                
  vcom  "$QSYS_SIMDIR/submodules/signal_generator.vhd"                                                             -work motor_control_unit_0                
  vcom  "$QSYS_SIMDIR/submodules/register_interface.vhd"                                                           -work registers                           
