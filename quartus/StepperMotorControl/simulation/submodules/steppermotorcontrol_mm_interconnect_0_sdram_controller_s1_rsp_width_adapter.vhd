-- steppermotorcontrol_mm_interconnect_0_sdram_controller_s1_rsp_width_adapter.vhd
...
entity steppermotorcontrol_mm_interconnect_0_sdram_controller_s1_rsp_width_adapter is
	generic (
		...
		IN_PKT_ORI_BURST_SIZE_L       : integer := 82;
		IN_PKT_ORI_BURST_SIZE_H       : integer := 84;
		...
		OUT_PKT_ORI_BURST_SIZE_L      : integer := 100;
		OUT_PKT_ORI_BURST_SIZE_H      : integer := 102;
...
end entity steppermotorcontrol_mm_interconnect_0_sdram_controller_s1_rsp_width_adapter;

architecture rtl of steppermotorcontrol_mm_interconnect_0_sdram_controller_s1_rsp_width_adapter is
...
begin
	...
	in_pkt_ori_burst_size_l_check : if IN_PKT_ORI_BURST_SIZE_L /= 82 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	in_pkt_ori_burst_size_h_check : if IN_PKT_ORI_BURST_SIZE_H /= 84 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_l_check : if OUT_PKT_ORI_BURST_SIZE_L /= 100 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_h_check : if OUT_PKT_ORI_BURST_SIZE_H /= 102 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	sdram_controller_s1_rsp_width_adapter : component altera_merlin_width_adapter
		generic map (
...
end architecture rtl; -- of steppermotorcontrol_mm_interconnect_0_sdram_controller_s1_rsp_width_adapter
