...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_cmd_demux_001 IS 
	 ...
	 ( 
		 ...
		 src13_data	:	OUT  STD_LOGIC_VECTOR (98 DOWNTO 0);
 ...
 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_cmd_demux_001 IS
	 ...
	 SIGNAL  s_wire_steppermotorcontrol_mm_interconnect_0_cmd_demux_001_wideor0_29_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_steppermotorcontrol_mm_interconnect_0_cmd_demux_001_wideor0_29_dataout <= (((((((((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0)) OR wire_w_lg_w_sink_channel_range21w22w(0)) OR wire_w_lg_w_sink_channel_range24w25w(0)) OR wire_w_lg_w_sink_channel_range27w28w(0)) OR wire_w_lg_w_sink_channel_range30w31w(0)) OR wire_w_lg_w_sink_channel_range33w34w(0)) OR wire_w_lg_w_sink_channel_range36w37w(0)) OR wire_w_lg_w_sink_channel_range39w40w(0));
	sink_ready <= s_wire_steppermotorcontrol_mm_interconnect_0_cmd_demux_001_wideor0_29_dataout;
	...
	src13_data <= ( sink_data(98 DOWNTO 0));
