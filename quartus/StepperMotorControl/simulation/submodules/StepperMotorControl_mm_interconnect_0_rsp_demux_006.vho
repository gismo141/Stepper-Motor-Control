...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_rsp_demux_006 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (102 DOWNTO 0);
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (102 DOWNTO 0);
		 src1_endofpacket	:	OUT  STD_LOGIC;
		 src1_ready	:	IN  STD_LOGIC;
		 src1_startofpacket	:	OUT  STD_LOGIC;
		 src1_valid	:	OUT  STD_LOGIC
	 ); 
 END StepperMotorControl_mm_interconnect_0_rsp_demux_006;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_rsp_demux_006 IS
 ...
 END RTL; --StepperMotorControl_mm_interconnect_0_rsp_demux_006
