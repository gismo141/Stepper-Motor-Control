...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_rsp_demux_005 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END StepperMotorControl_mm_interconnect_0_rsp_demux_005;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_rsp_demux_005 IS
 ...
 END RTL; --StepperMotorControl_mm_interconnect_0_rsp_demux_005
