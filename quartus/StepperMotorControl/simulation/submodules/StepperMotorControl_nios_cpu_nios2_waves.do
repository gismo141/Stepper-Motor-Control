add wave -noupdate -divider {StepperMotorControl_nios_cpu: top-level ports}
...
add wave -noupdate -divider {StepperMotorControl_nios_cpu: common}
...
add wave -noupdate -divider {StepperMotorControl_nios_cpu: breaks}
