...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_cmd_mux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END StepperMotorControl_mm_interconnect_0_cmd_mux_002;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_cmd_mux_002 IS
 ...
 END RTL; --StepperMotorControl_mm_interconnect_0_cmd_mux_002
