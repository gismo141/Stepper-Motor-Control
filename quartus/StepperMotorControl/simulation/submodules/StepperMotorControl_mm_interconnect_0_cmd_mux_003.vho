...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_cmd_mux_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END StepperMotorControl_mm_interconnect_0_cmd_mux_003;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_cmd_mux_003 IS
 ...
 END RTL; --StepperMotorControl_mm_interconnect_0_cmd_mux_003
