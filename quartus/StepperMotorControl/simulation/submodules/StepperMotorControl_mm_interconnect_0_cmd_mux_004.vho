...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_cmd_mux_004 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 sink0_channel	:	IN  STD_LOGIC_VECTOR (5 DOWNTO 0);
		 sink0_data	:	IN  STD_LOGIC_VECTOR (102 DOWNTO 0);
 ...
 END StepperMotorControl_mm_interconnect_0_cmd_mux_004;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_cmd_mux_004 IS
 ...
 BEGIN
	...
	src_channel <= ( sink0_channel(5 DOWNTO 0));
	src_data <= ( sink0_data(102 DOWNTO 0));
	src_endofpacket <= sink0_endofpacket;
	src_startofpacket <= sink0_startofpacket;
	src_valid <= sink0_valid;

 END RTL; --StepperMotorControl_mm_interconnect_0_cmd_mux_004
