...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_rsp_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END StepperMotorControl_mm_interconnect_0_rsp_demux_002;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_rsp_demux_002 IS
 ...
 BEGIN
	...
	src0_channel <= ( "0" & sink_channel(12 DOWNTO 1));
	src0_data <= ( sink_data(98 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));

 END RTL; --StepperMotorControl_mm_interconnect_0_rsp_demux_002
