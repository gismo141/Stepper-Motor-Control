-- steppermotorcontrol_mm_interconnect_0_sram_cvgx_uas_cmd_width_adapter.vhd
...
entity steppermotorcontrol_mm_interconnect_0_sram_cvgx_uas_cmd_width_adapter is
	generic (
		...
		IN_PKT_ORI_BURST_SIZE_L       : integer := 96;
		IN_PKT_ORI_BURST_SIZE_H       : integer := 98;
		...
		OUT_PKT_ORI_BURST_SIZE_L      : integer := 78;
		OUT_PKT_ORI_BURST_SIZE_H      : integer := 80;
...
end entity steppermotorcontrol_mm_interconnect_0_sram_cvgx_uas_cmd_width_adapter;

architecture rtl of steppermotorcontrol_mm_interconnect_0_sram_cvgx_uas_cmd_width_adapter is
...
begin
	...
	in_pkt_ori_burst_size_l_check : if IN_PKT_ORI_BURST_SIZE_L /= 96 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	in_pkt_ori_burst_size_h_check : if IN_PKT_ORI_BURST_SIZE_H /= 98 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_l_check : if OUT_PKT_ORI_BURST_SIZE_L /= 78 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_h_check : if OUT_PKT_ORI_BURST_SIZE_H /= 80 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	sram_cvgx_uas_cmd_width_adapter : component altera_merlin_width_adapter
		generic map (
...
end architecture rtl; -- of steppermotorcontrol_mm_interconnect_0_sram_cvgx_uas_cmd_width_adapter
