...
--synthesis_resources = 
 ...
 ENTITY  StepperMotorControl_mm_interconnect_0_cmd_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END StepperMotorControl_mm_interconnect_0_cmd_demux;

 ARCHITECTURE RTL OF StepperMotorControl_mm_interconnect_0_cmd_demux IS
 ...
 END RTL; --StepperMotorControl_mm_interconnect_0_cmd_demux
